 ...
 */
final readonly class SubscriberWasSetup implements EngineEvent
{
    ...
    {
        return sprintf('Subscriber for "%s" has been setup, changing status from %s to %s', $this->subscription->id->value, $this->previousStatus->value, $this->newStatus->value);
    }
}
